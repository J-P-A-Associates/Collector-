  ...
  return (
    <div className="p-8 max-w-6xl mx-auto relative min-h-screen pb-32">
      ...
      {(!collections || collections.length === 0) ? (
        <p className="text-xl text-gray-600 text-center py-12">No collections yet. Create your first one!</p>
      ) : (
      ...
      <Link
        href="/logout"
        className="fixed bottom-8 right-8 bg-red-600 text-white px-7 py-4 rounded-full shadow-2xl hover:bg-red-700 font-medium text-lg z-50"
      >
        Log Out
      </Link>
    </div>
